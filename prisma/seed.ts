...
const CLIENTS: Array<{
  ...
  { code: "LN", name: "Bluecrest Studio", type: "RETAINER", owner: "Jordan", stage: "In production", lane: "Onboarding" },
  { code: "IC", name: "Harbor & Vance Law", type: "RETAINER", owner: "Jordan", stage: "In production", lane: "Onboarding" },
  { code: "GR", name: "Ferro Fitness", type: "RETAINER", owner: "Jordan", stage: "In production", lane: "Onboarding" },
  { code: "OL", name: "Bellmore Legal", type: "RETAINER", owner: "Jordan", stage: "In production", lane: "Onboarding" },
  { code: "MC", name: "Coastal & Co", type: "RETAINER", owner: "Jordan", stage: "In production", lane: "Onboarding" },
  { code: "PZ", name: "Vantek Supply", type: "RETAINER", owner: "Jordan", stage: "In production", lane: "Onboarding" },
  {
    code: "EC",
    name: "Nimbus Cloud",
    type: "PROMO",
    ...
    contact: "Jamie Ellison",
    email: "jamie.ellison@example.com",
    plan: "—",
  ...
  },
  {
    ...
    email: "chris.bowman@example.com",
